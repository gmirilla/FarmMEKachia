...
<x-layouts.app>
    <div class="d-flex flex-row-reverse bd-highlight">
        <div class="p-2 bd-highlight" style="margin-right: 5px">
            <form method="get" action="{{ route('list_yield') }}">
                ...
                <button class="btn btn-primary" name="getyield"> Yield Details </button>
            </form>
        </div>
        <div class="p-2 bd-highlight" style="margin-right: 5px">
    ...
    @endif
    <div class="col-12 col-md col-xl col-sm py-md-3 pl-md-5t  fs-6, fs-md-5, fs-lg-5, fs-xl-1 card"
            ...
            <form method="post" action='/farm/updatefarm'>
                ...
                <div class="row gy-2 gx-3 align-items-center">
                    <div class="col-auto mb-3">
                        ...
                        <input type="text" placeholder="Farm Code" id="farmcode" name="farmcode" required
                            class="form-control" value="{{ $farm->farmcode }}">
                        <input type="text" value={{ $farm->id }} id="fid" name="fid" hidden>
                    </div>
                    <div class="mb-3 col-auto" style="margin-right: 10px">
                        <label for="fname" class="form-label">First Name</label>
                        <input type="text" value="{{ $farm->fname }}" id="fname" name="fname" required
                            class="form-control">
                    </div>
                    <div class="mb-3 col-auto" style="margin-right: 10px">
                        <label for="surname" class="form-label">Surname</label>
                        <input type="text" value="{{ $farm->surname }}" id="surname" name="surname" required
                            class="form-control">
                    </div>
                    <div class="mb-3 col-auto" style="margin-right: 10px">
                ...
                <div class="row gy-2 gx-3 align-items-center">
                    <div class="mb-3 col-auto">
                        ...
                        <input type="text" value="{{ $farm->community }}" id="community" name="community" required
                            class="form-control">
                    </div>
                    <div class="mb-3 col-auto">
                        <label for="city" class="form-label">City</label>
                        <input type="text" value="#TO DO" id="community" name="city" required
                            class="form-control">
                    </div>
                    <div class="mb-3 col-auto">
                    ...
                    <div class="mb-3 col-auto">
                        ...
                        <input type="text" value="{{ $farm->region }}" id="region" name="region" required
                            class="form-control">
                    </div>
                    <div class="mb-3 col-auto" style="border: 1px solid #ccc; padding: 10px; border-radius: 5px;">
                        <div class="text-center"
                            style="background-color: #d7e17c; border-bottom: 1px solid #ccc; padding: 10px;">House
                            Coordinates</div>
                        <label for="region" class="form-label">Latitude</label>
                        <input type="text" value="{{ $farm->latitude }}" id="latitude" name="latitude"
                            class="form-control">
                        <label for="region" class="form-label">Longitude</label>
                        <input type="text" value="{{ $farm->longitude }}" id="longitude" name="longitude"
                            class="form-control">
                ...
                <div class="row gy-2 gx-3 align-items-center">
                    <div class="mb-3 col-auto">
                        ...
                        <input type="text" value="{{ $farm->nooffarmunits }}" id="plots" name="plots"
                            disabled class="form-control">
                    </div>
                    <div class="mb-3 col-auto">
                        <label for="plots" class="form-label">Farm Area (Ha)</label>
                        <input type="text" value="{{ $farm->farmarea }}" id="farmarea" name="farmarea" disabled
                            class="form-control">
                    </div>
                    <div class="mb-3 col-auto">
                ...
                <div class="row gy-2 gx-3 align-items-center">
                    ...
                    <div class="col-auto mb-3">
                        ...
                        <select name="yearofcert" id="yearofcert" required class="form-select">
                            @if (!empty($farm->yearofcertification))
                                <option value="{{ $farm->yearofcertification }}" selected>
                                    {{ $farm->yearofcertification }}
                                </option>
                            @endif
    ...
    <script async src="https://maps.googleapis.com/maps/api/js?key={{ env('MAP') }}&libraries=geometry,drawing">
    </script>
    <script>
        function initMap() {
